...
class HostAdmin(admin.ModelAdmin):
    ...
    list_display = ('hostname', 'ip_addr', 'port', 'system_type', 'create_at', 'enabled')
...
class TaskLogAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'start_time', 'end_time', 'task_type', 'user', 'cmd', 'total_task', 'success_task', 'failed_task',
        'unknown_task', 'expire_time')
